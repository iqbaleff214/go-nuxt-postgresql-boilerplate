  ...
  <div class="min-h-screen bg-gray-50 flex">
    ...
    <aside class="w-60 bg-white border-r border-gray-100 flex flex-col shrink-0 sticky top-0 h-screen">
      ...
      <div class="h-16 flex items-center gap-2.5 px-5 border-b border-gray-100">
        ...
        <div>
          <span class="font-bold text-gray-900 text-sm tracking-tight leading-none block">MyApp</span>
          <span class="text-[10px] font-semibold text-emerald-600 uppercase tracking-widest">Admin</span>
        </div>
      </div>
      ...
      <div class="px-3 py-4 border-t border-gray-100">
        <NuxtLink
          to="/dashboard"
          class="flex items-center gap-3 rounded-lg px-3 py-2.5 text-sm font-medium text-gray-500 hover:bg-gray-50 hover:text-gray-700 transition-colors"
        >
